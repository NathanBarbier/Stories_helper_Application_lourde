...
{
    public partial class IconProject : UserControl
    {
        public IconProject()
        {
            InitializeComponent();
            ...
            int NbProjectOpen = ProjectRepository.GetProjectsByOrganization(Session.UserId, pagination: false).Count();
            int NbProjectArchived = ProjectRepository.GetProjectsByOrganization(Session.UserId, true, false, pagination: false).Count();

            Label TitreOpen = new Label();
            TitreOpen.Name = "TitreNbProjetOpen";
            TitreOpen.Text = "Projets Ouverts";
            ...
            NombreOpen.Text = NbProjectOpen.ToString();
            ...
            TitreArchived.Name = "TitreNbProjetsArchived";
            TitreArchived.Text = "Projets Archivés";
            ...
            NombreArchived.Text = NbProjectArchived.ToString();
